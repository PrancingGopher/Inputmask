        ...
        if (mask !== undefined) {
          ...
          if (dynMatches) {
            ...
            var targetSymbol = match[0][0],
              ndx = match.index;
            while (inputmask && (opts.placeholder[_validationTests.getTest.call(inputmask, ndx).match.placeholder] || _validationTests.getTest.call(inputmask, ndx).match.placeholder) === targetSymbol) {
              ndx++;
            }
...
function getTokenMatch(pos, opts, maskset) {
  var inputmask = this,
    masksetHint = maskset && maskset.tests[pos] ? opts.placeholder[maskset.tests[pos][0].match.placeholder] || maskset.tests[pos][0].match.placeholder : "",
    calcPos = 0,
    targetMatch,
    match,
    matchLength = 0;

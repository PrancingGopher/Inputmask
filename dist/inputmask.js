    ...
    return function() {
        ...
        var e = {
            ...
            6047: function(e, t, n) {
                ...
                var a, r = n(4351), o = (a = n(6266)) && a.__esModule ? a : {
                    default: a
                }, l = n(1507), s = n(6032), c = n(7539), u = n(7687), f = n(5895);
                function p() {
            ...
            4203: function(e, t, n) {
                var i = d(n(340)), a = d(n(3978)), r = n(6032), o = n(7539), l = n(5895);
                function s(e, t) {
                    return function(e) {
                        if (Array.isArray(e)) return e;
                    }(e) || function(e, t) {
                ...
                var h = a.default.dependencyLib, v = function() {
                    return e = function e(t, n, i, a) {
                            ...
                            for (S(t).lastIndex = 0; i = S(t).exec(this.format); ) {
                                ...
                                if (void 0 !== e) {
                                    if (a) {
                                        ...
                                        var p = f - i.index;
                                        o = e.slice(0, p || k[r] && k[r][4] || r.length);
                                    }
                                    e = e.slice(o.length);
                                }
                                Object.prototype.hasOwnProperty.call(k, r) && this.setValue(this, o, r, k[r][2], k[r][1]);
                            }
                        }
                    }, {
                        key: "setValue",
                        value: function(e, t, n, i, a) {
                            if (void 0 !== t) switch (i) {
                              ...
                              case "month":
                                if ("mmm" === n || "mmmm" === n) {
                                    e[i] = M("mmm" === n ? g.monthNames.slice(0, 12).findIndex((function(e) {
                                        return t.toLowerCase() === e.toLowerCase();
                                    })) + 1 : g.monthNames.slice(12, 24).findIndex((function(e) {
                                        return t.toLowerCase() === e.toLowerCase();
                            ...
                            if (void 0 !== a) {
                                ...
                                "day" === i && (y = !0, 0 === parseInt(r) && (r = 1)), "month" === i && (y = !0), 
                                "year" === i && (y = !0, r.length < k[n][4] && (r = M(r, k[n][4], !0))), ("" !== r && !isNaN(r) || "ampm" === i) && a.call(e._date, r);
                            }
                        }
                    }, {
                        key: "reset",
                    ...
                    } ]) && f(e.prototype, t), n && f(e, n), Object.defineProperty(e, "prototype", {
                        writable: !1
                    }), e;
                    var e, t, n;
                }(), m = (new Date).getFullYear(), g = a.default.prototype.i18n, y = !1, k = {
                    ...
                    mmm: [ g.monthNames.slice(0, 12).join("|"), function(e) {
                    ...
                    mmmm: [ g.monthNames.slice(12, 24).join("|"), function(e) {
                ...
                function E(e, t, n) {
                    return "string" == typeof e ? new v(e, t, n, this) : e && "object" === u(e) && Object.prototype.hasOwnProperty.call(e, "date") ? e : void 0;
                }
                function j(e, t) {
                ...
                a.default.extendAliases({
                    datetime: {
                        mask: function(e) {
                            return e.numericInput = !1, k.S = g.ordinalSuffix.join("|"), e.inputFormat = b[e.inputFormat] || e.inputFormat, 
                            e.displayFormat = b[e.displayFormat] || e.displayFormat || e.inputFormat, e.outputFormat = b[e.outputFormat] || e.outputFormat || e.inputFormat, 
                            e.regex = _(e.inputFormat, void 0, e), e.min = E(e.min, e.inputFormat, e), e.max = E(e.max, e.inputFormat, e), 
                            null;
                        },
                        placeholder: "",
                        ...
                        postValidation: function(e, t, n, i, a, r, o, s) {
                            var c, u, f = this;
                            if (o) return !0;
                            if (!1 === i && (((c = T.call(f, t + 1, a, r)).targetMatch && c.targetMatchIndex === t && c.targetMatch[0].length > 1 && void 0 !== k[c.targetMatch[0]] || (c = T.call(f, t + 2, a, r)).targetMatch && c.targetMatchIndex === t + 1 && c.targetMatch[0].length > 1 && void 0 !== k[c.targetMatch[0]]) && (u = w(c.targetMatch)[0]), 
                            ...
                            if (i.fuzzy && (e = i.buffer, t = i.pos), (c = T.call(f, t, a, r)).targetMatch && c.targetMatch[0] && void 0 !== k[c.targetMatch[0]]) {
                            ...
                            var g = i, y = E.call(f, e.join(""), a.inputFormat, a);
                            return g && !isNaN(y.date.getTime()) && (a.prefillYear && (g = function(e, t, n) {
                                if (e.year !== e.rawyear) {
                                    var i = m.toString(), a = e.rawyear.replace(/[^0-9]/g, ""), r = i.slice(0, a.length), o = i.slice(a.length);
                                    if (2 === a.length && a === r) {
                                        var l = new Date(m, e.month - 1, e.day);
                                        e.day == l.getDate() && (!n.max || n.max.date.getTime() >= l.getTime()) && (e.date.setFullYear(m), 
                                        e.year = i, t.insert = [ {
                                            pos: t.pos + 1,
                                            c: o[0]
                                        }, {
                                ...
                                t;
                            }(y, g = O.call(f, y, g, a), a, r)), void 0 !== t && g && i.pos !== t ? {
                        ...
                        onKeyDown: function(e, t, n, i) {
                            e.ctrlKey && e.key === r.keys.ArrowRight && (this.inputmask._valueSet(j(new Date, i)), 
                            h(this).trigger("setvalue"));
                        },
                        onUnMask: function(e, t, n) {
                            return t ? _(n.outputFormat, E.call(this, e, n.inputFormat, n), n, !0) : t;
                        },
            ...
            546: function(e, t, n) {
                var i = l(n(340)), a = l(n(3978)), r = n(6032), o = n(7539);
                function l(e) {
                    return e && e.__esModule ? e : {
                        default: e
                    };
            ...
            1507: function(e, t, n) {
                ...
                var i = n(4351), a = n(6047), r = n(6032), o = n(7539), l = n(7687), s = n(5895);
                function c(e, t, n, i) {
                ...
                if (h && h.head && h.head.attachShadow && a.default.customElements && void 0 === a.default.customElements.get("input-mask")) {
                    var v = function(e) {
                        function t() {
                            ...
                            var o = new r.default;
                            return o.dataAttribute = "", o.mask(e.input), e.input.inputmask.shadowRoot = i, 
                            e;
                        }
                        return function(e, t) {
            ...
            4507: function(e, t, n) {
                    ...
                    function o(e, t) {
                        ...
                        if (!0 === o) {
                            ...
                            f && f.forEach((function(t, n) {
                                ...
                                u = u.replace("]", ""), e = e.replace(new RegExp("".concat((0, a.default)(c), "\\[").concat((0, 
                                a.default)(u), "\\]")), c.charAt(0) === u.charAt(0) ? "(".concat(c, "|").concat(c).concat(u, ")") : "".concat(c, "[").concat(u, "]"));
                            }));
                        }
                        return e;
                    }
                ...
                var i = c(n(7332)), a = c(n(340)), r = c(n(3978)), o = c(n(9439));
                function l(e) {
            ...
            4240: function(e, t, n) {
                Object.defineProperty(t, "__esModule", {
                    ...
                    if (!1 !== u) {
                        ...
                        r.EventRuler.on(n, "focus", a.EventHandlers.focusEvent), r.EventRuler.on(n, "click", a.EventHandlers.clickEvent), 
                        r.EventRuler.on(n, "mouseleave", a.EventHandlers.mouseleaveEvent), r.EventRuler.on(n, "mouseenter", a.EventHandlers.mouseenterEvent), 
                        r.EventRuler.on(n, "paste", a.EventHandlers.pasteEvent), r.EventRuler.on(n, "cut", a.EventHandlers.cutEvent), 
                        r.EventRuler.on(n, "complete", t.oncomplete), r.EventRuler.on(n, "incomplete", t.onincomplete), 
                        r.EventRuler.on(n, "cleared", t.oncleared), !0 !== t.inputEventOnly && r.EventRuler.on(n, "keydown", a.EventHandlers.keyEvent), 
            ...
            7687: function(e, t, n) {
                ...
                function l(e, t, n, i, a, s) {
                    ...
                    if (void 0 !== v) {
                        ...
                        A = T.length - 1), (k = d.validPositions[b]) && !0 !== k.generatedInput && (void 0 === s || y < w || y >= S) && T.push(k.input), 
        ...
        return function() {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.default = void 0, n(8145), n(1669), n(1960), n(493), n(4829), n(4203), n(546), 
            n(2952);
